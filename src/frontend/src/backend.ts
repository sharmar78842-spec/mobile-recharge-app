...
export class Backend implements backendInterface {
    ...
    async getRecharge(arg0: bigint): Promise<Recharge> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecharge(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRechargeHistory(arg0: string): Promise<Array<Recharge>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRechargeHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitRecharge(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitRecharge(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
